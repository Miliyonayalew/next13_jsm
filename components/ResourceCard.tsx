...
const ResourceCard = ({id, title, image, downloadNumber, downloadLink}: Props) => {
  return (
    <Card className="w-ful mx-w-fit border-0 !bg-transparent sm:max-w-[356px]">
        <Link href={`resource/${downloadLink}`} target="_blank">
            ...
            <CardContent className="flex-between mt-4 p-0">
                ...
                <Link href={`/resource/${downloadLink}`} target="_blank" className="flex-center text-gradient_purple-blue body-semibold gap-1.5">
                    Download Now
